...
final class PseudoLeader extends PlayerImpl {
    /**
     * In the constructor, you need to call the constructor of PlayerImpl in the first line, so that you don't need to
     * care about how to connect to the platform. You may want to throw the two exceptions declared in the prototype, or
     * you may handle it by using "try {} catch {}". It's all up to you.
     *
     * @throws RemoteException
     * @throws NotBoundException
     */
    public PseudoLeader() throws RemoteException, NotBoundException {
    ...
    /**
     * You may want to delete this method if you don't want modify the original connection checking behavior of the
     * platform. Actually I recommend you to delete this method from your own code
     *
    ...
    /**
     * You may want to delete this method if you don't want the platform to control the exit behavior of your leader
     * class
     *
     * @throws RemoteException If implemented, the RemoteException *MUST* be thrown by this method
     */
