...
final class LSTMLeader extends PlayerImpl {
    private PayoffMaximizer maximizer;
    private StatisticalCollector collector;
    private Regression regression;

    public LSTMLeader() throws RemoteException, NotBoundException {
        super(PlayerType.LEADER, "LSTM Leader");
    }
    ...
    public void startSimulation(int simulationSteps) throws RemoteException {
        this.regression = new LSTMRegression(new NeuralNetUtil(PlatformUtil.getAllRecordsUntilDay(platform, 100)));
